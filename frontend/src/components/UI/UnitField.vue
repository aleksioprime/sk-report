  ...
  <div class="unit-field">
    ...
    <div class="unit-field-data" :class="{ 'unit-field-editing': fieldEdit && checkLoad }">
      <transition name="slide-fade">
        <div v-if="!(fieldEdit && checkLoad)" class="d-flex align-items-start">
          <div v-if="checkData">
    ...
    return {
      ...
      textField: {
        ...
        class_year: {
          ...
          warning: 'Внимание: при изменении года удаляется информация о выбранных образовательных целях)',
        },
        hours: {
          label: 'Часы',
        ...
        interdisciplinary: {
          label: 'Тип юнита',
          description: 'Выберите тип юнита'
        },
        description: {
          label: 'Описание',
        ...
        conceptual_understanding: {
          ...
          description: 'Напишите повествовательное предложение, которое отражает взаимосвязь между ключевой концепцией (концепциями) и, если применимо, междисциплинарной предметной концепцией (концепциями)'
        },
        global_context: {
          label: 'Глобальный контекст',
          description: 'Выберите один из шести глобальных контекстов MYP для преподавания и обучения',
          warning: 'Внимание: при изменении глобального контекста удаляется информация о выбранных линиях исследований)'
        },
        explorations: {
        ...
        aims: {
          label: 'Цели',
          description: 'Выберите, какие предметные цели будут достигнуты в данном юните'
        },
        objectives: {
          label: 'Цели предметной группы',
          description: 'Какие специальные цели MYP будут решаться в ходе изучения данного юнита',
          warning: 'Внимание: при изменении целей будут удалены некоторые данные)'
        },
        content: {
          label: 'Содержание (темы, знания и умения)',
          description: 'Опишите содержание юнита'
        },
        skills: {
          label: 'Умения',
          description: 'Какие умения позволят студенту достичь поставленных целей и выполнить задания итоговой работы'
        },
        criteria: {
          label: 'Критерии оценки',
          description: 'Какие критерии оценивания МУР используются?',
          warning: 'Внимание: при изменении критериев оценки будут удалены связанные предметные цели и записи в карте ATL-навыков'
        },
        learner_profile: {
          label: 'Выбор профилей студента IB',
          description: 'Какие характеристики профиля студента будут развиваться в ходе изучения юнита?'
        },
        description_lp: {
        ...
        service_as_action: { 
          ...
          description: 'В какой степени данный юнит вовлекает студентов в принципиальные действия? Что я могу сделать, чтобы использовать данный юнит для развития служения? Какие из следующих результатов обучения поддерживают данный юнит?'
        },
        formative_assessment: { 
          label: 'Текущее оценивание', 
          description: 'Предоставьте краткое описание текущего (их) задания (заданий)'
        },
        summative_assessment_task: {
          label: 'Итоговое оценивание (задания)',
          description: 'Предоставьте краткое описание итогового (ых) задания (заданий)' 
        },
